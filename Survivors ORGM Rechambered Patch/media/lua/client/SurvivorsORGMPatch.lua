...
for name, data in pairs(ORGMMasterWeaponTable) do
    -- this doesnt take into account weapon rarity but meh w/e
...
-- need to ensure survivors mod is loaded first, or use a event to replace the override functions.
-- cant use OnGameStart, some survivors have already spawned!
--Events.OnGameStart.Add(function() 
    -- inject our override functions
