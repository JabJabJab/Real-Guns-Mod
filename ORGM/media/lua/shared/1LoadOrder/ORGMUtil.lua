...
ORGM.createScriptItems = function(module, items)
    local script = {"module " .. module .. " {"}
...
ORGM.copyPropertiesTable = function(logPrefix, properties, source, destination)
...
--[[
testing block for using bitwise flags. All tests successful.
local bit = BitNumber.bit32
ORGM.log(ORGM.INFO, "bit number tests:")
ORGM.log(ORGM.INFO, "5 and 1 = " .. tostring(bit.band(5,1)))
ORGM.log(ORGM.INFO, "5 xor 1 = " .. tostring(bit.bxor(5,1)))
ORGM.log(ORGM.INFO, "5 xor 2 = " .. tostring(bit.bxor(5,2)))

ORGM.log(ORGM.INFO, "536870912+268435456+134217728 btest 134217728 = " .. tostring(bit.btest(536870912+268435456+134217728, 134217728)))
ORGM.log(ORGM.INFO, "536870912+268435456+134217728 btest 128 = " .. tostring(bit.btest(536870912+268435456+134217728, 128)))
